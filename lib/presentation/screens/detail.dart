      ...
      body: BlocBuilder<PokemonDetailsCubit, PokeDetail>(
        ...
        children: <Widget>[
          ...
          Row(
              mainAxisAlignment: MainAxisAlignment.spaceAround,
              children: <Widget>[
                Text('Height : ${details.height.toString()} m',
                    style: TextStyle(fontWeight: FontWeight.bold)),
                Text('Weight : ${details.weight.toString()} kg',
                    style: TextStyle(fontWeight: FontWeight.bold)),
              ]),
          SizedBox(
            height: 5,
          ...
          Row(
            ...
            children: <Widget>[
              Text(
                  'Base Experience : ${details.baseExperience.toString()}',
                  style: TextStyle(fontWeight: FontWeight.bold)),
              Text('Order : ${details.order.toString()}',
                  style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
          SizedBox(
